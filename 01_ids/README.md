...
| Raw format | 10 regional geodatabases |
| Main cleaned output | `ids_layers_cleaned.gpkg` |
...
| Step | Script | Role |
|---|---|---|
| 1 | [01_download_ids.R](scripts/01_download_ids.R) | Download the 10 regional geodatabases |
