...
├── cleaning_log.md           # Data quality issues and decisions about data handling
...
| `README.md` | Each dataset dir | Dataset overview, directory structure, quick-start commands, key outputs |
| `WORKFLOW.md` | Each dataset dir | Technical architecture, per-script details, usage examples |
| `cleaning_log.md` | `01_ids/`, `02_terraclimate/` | Data quality issues and decisions about data handling |
