...
|------|----------|--------------|
| [`README.md`](README.md) | Root | This file — project overview, quick start, workflow |
| [`ARCHITECTURE.md`](docs/ARCHITECTURE.md) | `docs/` | Pixel decomposition pattern shared by all climate datasets: workflow steps, time conventions, data schemas, weighted mean calculations, FIA point-based variant |
| [`TESTING.md`](docs/TESTING.md) | `docs/` | QC and validation scripts: what they check, when to run them, coverage gaps |
| [`SETUP.md`](scripts/SETUP.md) | `scripts/` | R and Python installation, GEE authentication, package setup, dashboard launch |
| [`config.yaml`](config.yaml) | Root | All dataset source URLs, variable definitions, scale factors, and processing parameters |
...
| File | What's in it |
|------|--------------|
| [`README.md`](01_ids/README.md) | Source overview, directory structure, feature counts, script list, key outputs, lookup table descriptions |
| [`WORKFLOW.md`](01_ids/WORKFLOW.md) | Pipeline diagram, all 5 production scripts with inputs/outputs, QC script descriptions |
| [`cleaning_log.md`](01_ids/cleaning_log.md) | 9 documented data quality issues (CRS, pancake features, field standardization, etc.) + processing decisions |
| [`scripts/qc/README.md`](01_ids/scripts/qc/README.md) | IDS QC scripts: what `validate_ids.R` and `explore_ids_coverage.R` check, what they output, when to run |
| `data_dictionary.csv` | Raw field definitions and metadata (generated by `02_inspect_ids.R`) |
| [`docs/ids_layers_overview.md`](01_ids/docs/ids_layers_overview.md) | Cleaned output field definitions and usage notes for the final GeoPackage layers |

**`02_terraclimate/` - TerraClimate:**

| File | What's in it |
|------|--------------|
| [`README.md`](02_terraclimate/README.md) | Source overview, directory structure, 3-step quick-start, outputs table, variable list, lookup files |
| [`WORKFLOW.md`](02_terraclimate/WORKFLOW.md) | Pixel decomposition architecture, per-script documentation, usage examples (filter by species/survey area), time conventions |
| [`cleaning_log.md`](02_terraclimate/cleaning_log.md) | 5 data quality issues (scale factors, coastal NoData, degenerate geometries, etc.) + design decisions |
...
| File | What's in it |
|------|--------------|
| [`README.md`](03_prism/README.md) | Source overview, directory structure, 2-step quick-start, outputs, variables, CONUS-only scope |
| [`WORKFLOW.md`](03_prism/WORKFLOW.md) | Web service streaming approach, per-script details, resolution comparison, design decisions |

**`04_worldclim/` - WorldClim:**

| File | What's in it |
|------|--------------|
| [`README.md`](04_worldclim/README.md) | Source overview, directory structure, 4-step quick-start, outputs, variables, decade file organization |
| [`WORKFLOW.md`](04_worldclim/WORKFLOW.md) | Bulk download approach, local GeoTIFF extraction details, design decisions |

**`05_fia/` - FIA Forest Inventory:**

| File | What's in it |
|------|--------------|
| [`README.md`](05_fia/README.md) | Source overview, directory structure, 6-script quick-start, key outputs (8 summary parquets), key metrics definitions |
| [`WORKFLOW.md`](05_fia/WORKFLOW.md) | Per-script technical details, data flow diagram, usage examples (filter plots, join climate), field reference, decisions log |
...
| Document | Purpose |
|----------|---------|
| [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) | **Shared pixel decomposition architecture** — workflow, time conventions, schemas, FIA point variant |
| [docs/TESTING.md](docs/TESTING.md) | **QC and validation** — what scripts exist, what they check, coverage gaps |
| [scripts/SETUP.md](scripts/SETUP.md) | Installation: R, Python, GEE authentication, `renv` setup, dashboard launch |
| [config.yaml](config.yaml) | Central configuration for all datasets (URLs, variables, parameters) |
| [01_ids/README.md](01_ids/README.md) | IDS: overview, structure, quick-start |
| [01_ids/WORKFLOW.md](01_ids/WORKFLOW.md) | IDS: pipeline diagram, per-script details |
| [01_ids/cleaning_log.md](01_ids/cleaning_log.md) | IDS: data quality issues and processing decisions |
| [01_ids/scripts/qc/README.md](01_ids/scripts/qc/README.md) | IDS QC scripts: what they check and what they produce |
| [02_terraclimate/README.md](02_terraclimate/README.md) | TerraClimate: overview, structure, quick-start |
| [02_terraclimate/WORKFLOW.md](02_terraclimate/WORKFLOW.md) | TerraClimate: pixel decomposition, GEE extraction, usage examples |
| [02_terraclimate/cleaning_log.md](02_terraclimate/cleaning_log.md) | TerraClimate: data quality issues and design decisions |
| [03_prism/README.md](03_prism/README.md) | PRISM: overview, structure, quick-start |
| [03_prism/WORKFLOW.md](03_prism/WORKFLOW.md) | PRISM: web service streaming approach, per-script details |
| [04_worldclim/README.md](04_worldclim/README.md) | WorldClim: overview, structure, quick-start |
| [04_worldclim/WORKFLOW.md](04_worldclim/WORKFLOW.md) | WorldClim: bulk download, local GeoTIFF extraction |
| [05_fia/README.md](05_fia/README.md) | FIA: overview, structure, quick-start, key outputs |
| [05_fia/WORKFLOW.md](05_fia/WORKFLOW.md) | FIA: per-script details, usage examples, field reference |

> For file descriptions organized by directory, see [Documentation Guide](#documentation-guide) above.
