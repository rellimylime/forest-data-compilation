# ==============================================================================
# 01_build_condition_community_climate.R
# Community climate affinity for each FIA condition.
#
# For one community layer, joins each species to its climate niche and computes
# both a weighted mean and a weighted median of the eight niche indicators,
# keeping FIA conditions separate. Because a CWM is a ratio, these values are
# unaffected by condition size; condition area is applied once downstream by
# 02_build_forest_plot_visit_cwm.R.
#
# Contains every FIA condition class. A forest-specific workflow must filter
# COND_STATUS_CD == 1, or use the plot-visit product from script 02 instead.
#
# Supported layers:
...
#   Rscript 07_thermophilization/scripts/01_build_condition_community_climate.R --layer=trees --weight=ba_per_acre
