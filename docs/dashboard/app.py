...
PIPELINE = [
    ...
    ("IDS", "Damage area → surveyed area",
     "processed/ids/damage_area_to_surveyed_area.parquet",
     "Spatial assignment of each damage area to its enclosing surveyed area"),
    ("IDS", "Damage area metrics",
     "processed/ids/damage_area_area_metrics.parquet",
     "Area sizes and survey coverage fractions per damage area"),
